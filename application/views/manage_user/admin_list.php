    ...
    <div id="main">
        ...
        <div class="page-heading">
            <div class="page-title">
                <h3 class="text-dark">Admin Account</h3>
                <p class="text-subtitle text-muted">See and manage all admin account</p>
            </div>
        </div>
                                    ...
                                    <?php foreach ($row as $key) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form role="form" action="<?= site_url('users_user/hapus_admin') ?>" method="post">
                                                    <input name="he" type="hidden" value="<?= $key['id']; ?>">
