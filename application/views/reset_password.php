                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="<?= base_url() ?>bootstrap/assets/img/Logo.png" alt="logo" width="100" class="shadow-light ">
                        </div>

                        <div class="card card-dark">
                            <div class="card-header">
                                <h4 class="textcolor text-dark">Reset Password</h4>
                            </div>

                            <div class="card-body">

                                <p class="text-muted"></p>
                                <?= $this->session->flashdata('pemberitahuan2') ?>
